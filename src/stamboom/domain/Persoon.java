...
public class Persoon {
    ...
    Persoon(int persNr, String[] vnamen, String anaam, String tvoegsel,
        ...
        //todo opgave 1       
        for(String n : vnamen){
            n = n.substring(0, 1).toUpperCase() + n.substring(1, (n.length() -1)).toLowerCase();
        }
        anaam = anaam.substring(0, 1).toUpperCase() + anaam.substring(1, (anaam.length() -1)).toLowerCase();
        gebplaats = gebplaats.substring(0, 1).toUpperCase() + gebplaats.substring(1, (anaam.length() -1)).toLowerCase();
